        ...
        <>
            <Listbox value={selectedGroup} onChange={setSelectedGroup}>
                ...
                <Transition
                    ...
                    leaveTo='opacity-0'
                >
                    <Listbox.Options className="absolute z-30 mt-1 max-h-[135px] w-full overflow-auto rounded-md bg-white py-1 px-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                        {
