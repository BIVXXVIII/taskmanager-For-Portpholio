...
⋅⋅⋅ From the beginning point of the project was been a practice, and not created like comercial project.\_\_
...
⋅⋅⋅ **_Suport libraries:_** React-router-dom _(browser routing)_, headless.ui \_(UI components for React with tailwind suport)\_\_\_
...
All group sorted by a search value from search field what we have in **Layaout** component.\_\_
...
⋅⋅⋅ **_Супутні бібліотеки:_** React-router-dom _(браузерний роутинг)_, headless.ui \_(UI компоненти для React з підтримкою tailwind)\_\_\_
...
⋅⋅⋅ В компоненті реалізованна панель керування де ви можете:\_\_
...
⋅⋅⋅ Ключовий компонент, який рендерить всі группи у вигляді картки группи з стану групп программи. Всі группи відсортовані по співпадінню зі значенням пошку з поля пошуку в шапці макету.\_\_
